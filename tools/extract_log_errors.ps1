<#
.SYNOPSIS
    Extracts Fertilizer Depot-related errors and warnings from FS25 game log.

.DESCRIPTION
    Parses the Farming Simulator 25 log.txt file and extracts all entries
    related to the Fertilizer Depot mod, categorizing them by severity and type.
...
Write-Header "Fertilizer Depot Log Analyzer"
...
$report = @()
$report += "=" * 60
$report += "Fertilizer Depot Error Report"
